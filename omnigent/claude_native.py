...
_CLAUDE_CODE_DISABLE_ALTERNATE_SCREEN_ENV = "CLAUDE_CODE_DISABLE_ALTERNATE_SCREEN"
...
def build_native_claude_terminal_env(
    ...
    and keeps the classic renderer required by tmux capture/injection.
    ...
    terminal_env = {
        ...
        _CLAUDE_CODE_DISABLE_ALTERNATE_SCREEN_ENV: "1",
    }
    if claude_config is not None:
        ...
        terminal_env[_CLAUDE_CODE_DISABLE_ALTERNATE_SCREEN_ENV] = "1"
